...
DECLARE_SPELL_FUN(	spell_freefall		);
DECLARE_SPELL_FUN(      spell_frenzy		);
DECLARE_SPELL_FUN(	spell_gate		);
DECLARE_SPELL_FUN(	spell_giant_strength	);
DECLARE_SPELL_FUN(	spell_gravija		);
DECLARE_SPELL_FUN(	spell_harm		);
DECLARE_SPELL_FUN(      spell_haste		);
DECLARE_SPELL_FUN(	spell_heal		);
DECLARE_SPELL_FUN(	spell_mana		);
DECLARE_SPELL_FUN(	spell_heat_metal	);
DECLARE_SPELL_FUN(	spell_heavy_blow	);
DECLARE_SPELL_FUN(	spell_hellbender	);
...
DECLARE_SPELL_FUN(	spell_chibichibi	);
...
DECLARE_SPELL_FUN(	spell_energizer		);
DECLARE_SPELL_FUN(	spell_draguslave	);
DECLARE_SPELL_FUN(	spell_ratilt		);
DECLARE_SPELL_FUN(	spell_laguna_blade	);
