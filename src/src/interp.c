...
const struct cmd_type cmd_table[] = {
    ...
    {"n", do_north, POS_STANDING, 0, LOG_NEVER, 0},
    {"east", do_east, POS_STANDING, 0, LOG_NEVER, 0},
    {"e", do_east, POS_STANDING, 0, LOG_NEVER, 0},
    {"south", do_south, POS_STANDING, 0, LOG_NEVER, 0},
    {"s", do_south, POS_STANDING, 0, LOG_NEVER, 0},
    {"west", do_west, POS_STANDING, 0, LOG_NEVER, 0},
    {"w", do_west, POS_STANDING, 0, LOG_NEVER, 0},
    {"up", do_up, POS_STANDING, 0, LOG_NEVER, 0},
    {"u", do_up, POS_STANDING, 0, LOG_NEVER, 0},
    {"down", do_down, POS_STANDING, 0, LOG_NEVER, 0},
    {"d", do_down, POS_STANDING, 0, LOG_NEVER, 0},

    /*
     * Common other commands.
     * Placed here so one and two letter abbreviations work.
     */
    {"at", do_at, POS_DEAD, 95, LOG_NORMAL, 1},
    {"cast", do_cast, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"auction", do_autoauction, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"ban", do_ban, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"buy", do_buy, POS_RESTING, 0, LOG_NORMAL, 1},
    {"channels", do_channels, POS_DEAD, 0, LOG_NORMAL, 1},
    /*EE960524 */
    {"dual", do_dual, POS_RESTING, 0, LOG_NORMAL, 1},
    {"donate", do_donate, POS_RESTING, 0, LOG_NORMAL, 1},
    {"drag", do_drag, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"exits", do_exits, POS_RESTING, 0, LOG_NORMAL, 1},
    {"get", do_get, POS_RESTING, 0, LOG_NORMAL, 1},
    {"goto", do_goto, POS_DEAD, 95, LOG_NORMAL, 1},
    {"group", do_group, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"guild", do_guild, POS_DEAD, 94, LOG_ALWAYS, 1},
    {"guntoggle", do_gtoggle, POS_RESTING, 0, LOG_NORMAL, 1},
    ...
    {"clanldr", do_clanldr, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"sockets", do_sockets, POS_DEAD, 95, LOG_NORMAL, 1},
    ...
    {"wizhelp", do_wizhelp, POS_DEAD, 95, LOG_NORMAL, 1},
...
/*  { "groups",	    do_groups,	    POS_SLEEPING,    0,  LOG_NORMAL, 1 }, */
    ...
    {"qinfo", do_info, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"songs", do_songs, POS_DEAD, 0, LOG_NORMAL, 1},
    ...
    {"ovalue", do_ovalue, POS_RESTING, 0, LOG_NORMAL, 1},
    {"ooc", do_ooc, POS_SLEEPING, 1, LOG_NORMAL, 1},
    ...
    {"auto", do_autolist, POS_DEAD, 0, LOG_NORMAL, 1},
    {"autolist", do_autolist, POS_DEAD, 0, LOG_NORMAL, 1},
    {"autoquest", do_autoqst, POS_RESTING, 0, LOG_ALWAYS, 1},
    {"autoassist", do_autoassist, POS_DEAD, 0, LOG_NORMAL, 1},

    {"rsay", do_rsay, POS_DEAD, 0, LOG_NORMAL, 1},
    {"dtoggle", do_dtoggle, POS_DEAD, 0, LOG_NORMAL, 1},
    {"nofly", do_nofly, POS_DEAD, 0, LOG_NORMAL, 1},
    {"refly", do_refly, POS_DEAD, 0, LOG_NORMAL, 1},
...
/*  { "channels",	do_channels,	POS_DEAD, 	 0,  LOG_NORMAL, 1 }, */
    {"cls", do_cls, POS_DEAD, 0, LOG_NORMAL, 1},
    {"clear", do_cls, POS_DEAD, 0, LOG_NORMAL, 1},
    {"cload", do_cload, POS_DEAD, 94, LOG_NORMAL, 1},
    {"cskill", do_cskill, POS_DEAD, 94, LOG_NORMAL, 1},
...
/*  { "music",		do_music,		POS_SLEEPING,	 0,  LOG_NORMAL, 1 },*/
    ...
    {"whisper", do_whisper, POS_SLEEPING, 0, LOG_NORMAL, 1},
...
/*  { "unlock",		do_unlock,		POS_RESTING,	 0,  LOG_NORMAL, 1 }, */
    ...
    {"poison", do_poison, POS_RESTING, 0, LOG_NORMAL, 1},
    ...
    {"battle rage", do_rage, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"heighten", do_senses, POS_FIGHTING, 0, LOG_NORMAL, 1},
/*    {"possess", do_possess, POS_FIGHTING, 0, LOG_NORMAL, 1}, SZ020426 */
    {"demonrage", do_demonrage, POS_FIGHTING, 0,  LOG_NORMAL, 1},
    ...
    {"rapidstrike", do_rapidstrike, POS_FIGHTING, 0, LOG_NORMAL, 1 },
    {"rescue", do_rescue, POS_FIGHTING, 0, LOG_NORMAL, 0},
    {"shoot", do_shoot, POS_FIGHTING, 0, LOG_NORMAL, 0},
    { "surrender",    do_surrender,   POS_FIGHTING,    0,  LOG_NORMAL, 1 },
    {"trip", do_trip, POS_FIGHTING, 0, LOG_NORMAL, 1},
    /* MOB COMMAND (HERE FOR FASTER SCAN) */
    { "mob",          do_mob,         POS_DEAD,        0,  LOG_NEVER,  0 },
    {"dragonp", do_dragonp, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"hurricane", do_hurricane, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"footsweep", do_footsweep, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"circle", do_circle, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"roundhouse", do_roundhouse, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"flashkick", do_flashkick, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"vanishing", do_vanishing, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"optic", do_optic, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"kamehameha", do_kamehameha, POS_FIGHTING, 0, LOG_NORMAL, 1},
    ...
    {"smoke bomb", do_smoke, POS_FIGHTING, 0, LOG_NORMAL, 1},
    /*
     * Miscellaneous commands.
     */
    {"astring", do_astring, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"aqstring", do_astring, POS_SLEEPING, 0, LOG_NORMAL, 1},
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    {"rpconv", do_rpconv, POS_DEAD, 0, LOG_NORMAL, 0},
    {"save", do_save, POS_DEAD, 0, LOG_NORMAL, 1},
    {"sing", do_sing, POS_STANDING, 0, LOG_NORMAL, 1},
    ...
    {"testaqstring", do_teststring, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    /*EE960410 */
    {"pkset", do_pkset, POS_RESTING, 0, LOG_ALWAYS, 1},

    /*
     * Immortal commands.
     */
    {"advance", do_advance, POS_DEAD, 100, LOG_ALWAYS, 1},
    /*TG980628 */
    {"award", do_award, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"btitle", do_btitle, POS_DEAD, 95, LOG_NORMAL, 0},
    {"dump", do_dump, POS_DEAD, 99, LOG_ALWAYS, 0},
    {"trust", do_trust, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"violate", do_violate, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"allow", do_allow, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"deny", do_deny, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"disconnect", do_disconnect, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"flag", do_flag, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"freeze", do_freeze, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"perm", do_perm, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"permban", do_permban, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"protect", do_protect, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"reboo", do_reboo, POS_DEAD, 99, LOG_NORMAL, 0},
    {"reboot", do_reboot, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"set", do_set, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"shutdow", do_shutdow, POS_DEAD, 100, LOG_NORMAL, 0},
    {"shutdown", do_shutdown, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"wizlock", do_wizlock, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"world", do_world, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"force", do_force, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"load", do_load, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"newlock", do_newlock, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"nochannels", do_nochannels, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"noemote", do_noemote, POS_DEAD, 98, LOG_ALWAYS, 1},
    {"noshout", do_noshout, POS_DEAD, 98, LOG_ALWAYS, 1},
    {"notell", do_notell, POS_DEAD, 98, LOG_ALWAYS, 1},
    {"pecho", do_pecho, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"pardon", do_pardon, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"promote", do_promote, POS_SLEEPING, 94, LOG_ALWAYS, 1},
    {"purge", do_purge, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"restore", do_restore, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"sla", do_sla, POS_DEAD, 99, LOG_NORMAL, 0},
    {"slay", do_slay, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"teleport", do_transfer, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"tport", do_tport, POS_FIGHTING, 0, LOG_NORMAL, 1}, /* Really morts... */
    {"transfer", do_transfer, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"poofin", do_bamfin, POS_DEAD, 95, LOG_NORMAL, 1},
    {"poofout", do_bamfout, POS_DEAD, 95, LOG_NORMAL, 1},
    {"gecho", do_echo, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"holylight", do_holylight, POS_DEAD, 95, LOG_NORMAL, 1},
    {"incognito", do_incognito, POS_DEAD, 97, LOG_NORMAL, 1},
    {"invis", do_invis, POS_DEAD, 99, LOG_NORMAL, 0},
    {"log", do_log, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"memory", do_memory, POS_DEAD, 100, LOG_NORMAL, 1},
    {"mwhere", do_mwhere, POS_DEAD, 95, LOG_NORMAL, 1},
    {"owhere", do_owhere, POS_DEAD, 95, LOG_NORMAL, 1},
    {"peace", do_peace, POS_DEAD, 95, LOG_NORMAL, 1},
    {"penalty", do_penalty, POS_DEAD, 95, LOG_NORMAL, 1},
    {"echo", do_recho, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"return", do_return, POS_DEAD, 97, LOG_NORMAL, 1},
    {"snoop", do_snoop, POS_DEAD, 99, LOG_ALWAYS, 1},
    {"stat", do_stat, POS_DEAD, 95, LOG_NORMAL, 1},
    {"string", do_string, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"switch", do_switch, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"wizinvis", do_invis, POS_DEAD, 99, LOG_NORMAL, 1},
    {"vnum", do_vnum, POS_DEAD, 97, LOG_NORMAL, 1},
    {"zecho", do_zecho, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"clone", do_clone, POS_DEAD, 96, LOG_ALWAYS, 1},
    {"wiznet", do_wiznet, POS_DEAD, 95, LOG_NORMAL, 1},
    {"admint", do_admintalk, POS_DEAD, 99, LOG_NORMAL, 1},
    {"immtalk", do_immtalk, POS_DEAD, 95, LOG_NORMAL, 1},
    {"imptalk", do_imptalk, POS_DEAD, 100, LOG_NORMAL, 1},
    {"wiztalk", do_wiztalk, POS_DEAD, 98, LOG_NORMAL, 1},
    {"imotd", do_imotd, POS_DEAD, 95, LOG_NORMAL, 1},
    {":", do_immtalk, POS_DEAD, 95, LOG_NORMAL, 0},
    {"smote", do_smote, POS_DEAD, 95, LOG_NORMAL, 1},
    {"necho", do_necho, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"lag", do_lag, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"review", do_review, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"noreply", do_noreply, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"seize", do_seize, POS_DEAD, 96, LOG_ALWAYS, 1},
    {"jail", do_jail, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"qecho", do_qecho, POS_DEAD, 97, LOG_ALWAYS, 1},
    {"char_fry", do_fry, POS_DEAD, 96, LOG_ALWAYS, 1},
    {"rename", do_rename, POS_DEAD, 95, LOG_ALWAYS, 1},
    {"grant", do_grant, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"gstat", do_gstat, POS_DEAD, 100, LOG_NORMAL, 1},
    {"revoke", do_revoke, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"validate", do_validate, POS_DEAD, 98, LOG_ALWAYS, 1},
    {"linkload", do_linkload, POS_DEAD, 100, LOG_ALWAYS, 1},
    {"linkdrop", do_linkdrop, POS_DEAD, 100, LOG_ALWAYS, 1},

/* New clan toys - Suzuran, 26-jun-2000 */
    {"clanctl", do_clanctl, POS_DEAD, 100, LOG_ALWAYS, 1},

/* For my use. */
    {"sz_version", do_szversion, POS_DEAD, 1, LOG_NORMAL, 1},
    /*    {"sz_fkb", sz_fukubuster, POS_DEAD, 95, LOG_NORMAL, 1}, */

/*
    { "prefi",		do_prefi,		POS_DEAD,		WZ,  LOG_NORMAL, 0 },
    { "prefix",		do_prefix,		POS_DEAD,		WZ,  LOG_NORMAL, 1 },
*/

    /* MOBPROGS AND OLC - SUZURAN */
    ...
    {"maxstats", do_maxstats, POS_DEAD, 0, LOG_NORMAL, 1},
...
/*&&   cmd_table[cmd].level <= trust ) *//* grant change */
	{
	    /*found = TRUE;
   break; *//* grant change */
     ...
     * Log and snoop.
     */
/* TC960910  it's uninteresting to have empty log lines */
/*    if ( cmd_table[cmd].log == LOG_NEVER )
	strcpy( logline, "" );
*/
    if (((!IS_NPC(ch) && IS_SET(ch->act, PLR_LOG))
	 || fLogAll
	 || cmd_table[cmd].log == LOG_ALWAYS) && cmd_table[cmd].log != LOG_NEVER) {	/* Don't write those to log */
...
/* one_argument, case insensitive version */
char *ci_one_argument(char *argument, char *arg_first)
{
    char cEnd;
...
void do_wizhelp(CHAR_DATA * ch, char *argument)
{
    ...
    for (cmd = 0; cmd_table[cmd].name[0] != '\0'; cmd++) {
	if (cmd_table[cmd].level >= LEVEL_HERO
/*&&   cmd_table[cmd].level <= get_trust( ch ) *//* grant */
