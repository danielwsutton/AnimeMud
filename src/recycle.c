...
void free_obj(OBJ_DATA * obj)
{
    ...
    free_string(obj->iname);
    free_string(obj->clone);
...
void free_char(CHAR_DATA * ch)
{
    ...
    free_note(ch->pnote);	/* TDG000728 Fixed mem leak! */
...
void free_pcdata(PC_DATA * pcdata)
{
    ...
    free_string(pcdata->bracket_title);	/*TG980713 */
/*free_string(pcdata->walkin); *//*EE960526 */
/*free_string(pcdata->walkout); *//*EE960526 */
    free_string(pcdata->title);

    /* Tsk, tsk, Vorlin!  Bad boy! */
...
/* NUKE FSCKING CHEATERS - Suzuran - This makes this ID unique without
   screwing up the next base value in sequence. (In theory at least.) */
    val = val + number_range(0, 100);
